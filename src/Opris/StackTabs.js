...
const StackTabs = () => {
    ...
    const tabContent = {
        tab1: [
            { img: './images/stack-icon1.svg', title: 'Ethereum' },
            { img: './images/stack-icon2.svg', title: 'Polygen' },
            { img: './images/stack-icon3.svg', title: 'Solana' },
            { img: './images/stack-icon4.svg', title: 'Avalanche' },
        ],
        tab2: [
            { img: './images/stack-icon1.svg', title: 'Corda' },
            { img: './images/stack-icon2.svg', title: 'Quorum' },
            { img: './images/stack-icon3.svg', title: 'Hyperledger Sawtooth' },
            { img: './images/stack-icon4.svg', title: 'Stellar' },
        ],
        tab3: [
            { img: './images/stack-icon1.svg', title: 'Java' },
            { img: './images/stack-icon2.svg', title: 'Python' },
            { img: './images/stack-icon3.svg', title: 'Solidity' },
            { img: './images/stack-icon4.svg', title: 'JavaScript' },
        ],
        tab4: [
            { img: './images/stack-icon1.svg', title: 'Ethereum' },
            { img: './images/stack-icon2.svg', title: 'Polygen' },
        ...
        tab5: [
            { img: './images/stack-icon1.svg', title: 'BitTorrent' },
            { img: './images/stack-icon2.svg', title: 'Distributed ledger' },
            { img: './images/stack-icon3.svg', title: 'Sia' },
            { img: './images/stack-icon4.svg', title: 'Filecoin' },
        ],
    };
    return (
